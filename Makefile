...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Feb 9 15:14:00 2019
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Mastermind1.0.0/ && $(COPY_FILE) --parents mmwindow.h Mastermind.hxx .tmp/Mastermind1.0.0/ && $(COPY_FILE) --parents main.cpp mmwindow.cpp Mastermind.cxx .tmp/Mastermind1.0.0/ && $(COPY_FILE) --parents mmwindow.ui .tmp/Mastermind1.0.0/ && (cd `dirname .tmp/Mastermind1.0.0` && $(TAR) Mastermind1.0.0.tar Mastermind1.0.0 && $(COMPRESS) Mastermind1.0.0.tar) && $(MOVE) `dirname .tmp/Mastermind1.0.0`/Mastermind1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Mastermind1.0.0
